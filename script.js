questions = [
  ...
  {q:'Quel attribut permet d’ouvrir un lien dans un nouvel onglet ?', opts:['href','target','rel','src'], ans:1},
  ...
  {q:'À quoi sert document.getElementById ?', opts:['Sélectionner un élément par son identifiant','Créer un nouvel élément HTML','Modifier le style CSS','Afficher une alerte'], ans:0},
